...
namespace Clinic_System.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString, string currentFilter, int? page)
        {
            ...
            ViewData["NameSortParm"] = String.IsNullOrEmpty(sortOrder) ? "appointment_desc" : "";
            ...
            {
                appointments = appointments.Where(p => p.AppointmentDescr.Contains(searchString));
            ...
            switch (sortOrder)
            {
                case "appointment_desc":
                    appointments = appointments.OrderByDescending(p => p.AppointmentDescr);
                    break;

                default:
                    appointments = appointments.OrderBy(p => p.AppointmentDate);
                    break;
            }
            int pageSize = 3;
            ...
            return View(await PaginatedList<Appointment>.CreateAsync(appointments.AsNoTracking(), page ?? 1, pageSize));
        }
